...
function DeleteUserLogo() {
  return (
    <div>
      <svg fill="#FF7373" width="25px" height="25px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" stroke="#000000" strokeWidth="0.00024000000000000003">
