...
function InputAttendeeManual({newAttendee, setNewAttendee}) {
  return (
    ...
    <h1 className="text-2xl font-bold text-center mb-5 text-limeConvined">
        משתתף חדש
    </h1>
    <div className="flex flex-col gap-4">
        ...
        <div className="flex flex-col">
            ...
            <input
                ...
                className="bg-gray-600 p-2 rounded focus:outline-none focus:ring-2 focus:ring-turquiseConvined"
            />
            <small className="text-redConvinedStronger mt-1">חובה למלא תעודה מזהה</small>
        </div>
        ...
        <div className="flex flex-col">
            <label htmlFor="attendance" className="text-white font-semibold">נוכחות</label>
            <select
                id="attendance"
                value={""}
            ...
            <small className="text-gray-400 mt-1">שדה לא חובה </small>
        </div>
